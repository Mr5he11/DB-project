            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="alert alert-info text-center">
                        <h3> HI, ADMIN! </h3> 
                        <p>
                            Here you can delete or modify informations about every user.
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="list-group list-group-flush" id="myUL">
                                <?php
                                $users = $conn->query('SELECT * FROM Utenti WHERE Amministratore = 0 ORDER BY Cognome');
                                while($row = $users->fetch()){
                                    $name = strtoupper($row['Nome']);
                                    $surname = strtoupper($row['Cognome']);
                                    $mail = $row['Mail'];
                                    echo('<li class="list-group-item "><a href="update-user.php?mail='.$mail.'">'.$name.' '.$surname.'</a></li>');                                }
                                ?>
                            </ul> 
                        </div>
